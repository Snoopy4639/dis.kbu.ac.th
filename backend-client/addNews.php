    ...
    <div class="container-fluid">
        <div class="col-12">
            <div class="col-10 offset-1">
                ...
                <div class="col-12">&nbsp;</div>
                <label class="header">เพิ่มข่าวประชาสัมพันธ์</label>
                <form action="src/backend/add-news.php" method="POST" name="registerForm" onSubmit="JavaScript:return checkSubmit();"
                            ...
                            <div class="row">
                                <div class="col-md-4 text-center">
                                    <div class="w3-card-2 w3-white">
                                        <div class="col-12">&nbsp;</div>
                                        <img id="profile_image" src="src/image/box.png" class="img-fluid upload-profile">
                                        <div class="col-12">&nbsp;</div>
                                        <label class="w3-button w3-block w3-blue mini-header" style="padding-top: 5%; padding-bottom: 5%">
                                            <i class="fa fa-cloud-upload icon-detail"></i>&nbsp;&nbsp;
                                            Upload รูปภาพประชาสัมพันธ์
                                            <input name="itemPicUpload" type="file" hidden onchange="preview_image(event)" id="profile_image_upload">
                                        </label>
                                    </div>
                                </div>
                                <div class="col-8">
                                    <div class="w3-card-2 w3-white">
                                        <div class="container-fluid">
                                            ...
                                            <div class="w3-row-padding">
                                                <label class="detail"><i class="fa fa-list icon-detail"></i>&nbsp;&nbsp;ชื่อหัวข้อข่าว <font class="text-danger">*</font></label>
                                                <input name="newsTitleInput" class="w3-input" type="text" autocomplete="off" required>
                                            </div>
                                            <div class="col-12">&nbsp;</div>
                                            <div class="w3-row-padding">
                                                <label class="detail">&nbsp;&nbsp;<i class="fa fa-pencil icon-detail"></i>&nbsp;&nbsp;รายละเอียดของข่าว <font class="text-danger">*</font></label>
                                                <textarea name="newsDetailInput" class="w3-input w3-border" rows="5" col="5" resize="none" autocomplete="off" required></textarea>
                                            </div>
                                            <div class="col-12">
                                ...
                                <div class="col-12 text-center">
                                    <button class="w3-button w3-green" type="button" onclick="document.getElementById('confirmSave').style.display='block'">
                                        <i class="fa fa-check icon-detail"></i>&nbsp;&nbsp;เพิ่มข่าวประชาสัมพันธ์
                                    </button>
                    ...
                    <div id="confirmSave" class="w3-modal">
                        <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:600px">
                            <div class="w3-center"><br>
                                ...
                                <label class="header"><font size="+3">ยืนยันการเพิ่มข่าวประชาสัมพันธ์</font></label><br>
