...
<body>
    ...
    <form action="src/backend/update-news.php" method="POST" name="registerForm" onSubmit="JavaScript:return checkSubmit();"
    ...
    <div class="container-fulid">
        <div class="col-12">
            ...
            <div class="col-10 offset-1">
                <label class="header">รายการข่าวประชาสัมพันธ์ : <?php echo($result['news_title']);?></label>
                            ...
                            <div class="row">
                                <div class="col-md-4 text-center">
                                    <div class="w3-card-2 w3-white">
                                        <div class="col-12">&nbsp;</div>
                                        <img id="profile_image" src="src/backend/upload/news/<?php echo($result['news_pic_path']);?>" class="img-fluid upload-profile">
                                        <div class="col-12">&nbsp;</div>
                                    </div>
                                </div>
                                <div class="col-8">
                                    <div class="w3-card-2 w3-white">
                                        <div class="container-fluid">
                                            ...
                                            <div class="w3-row-padding">
                                                ...
                                                <input name="newsTitleInput" class="w3-input w3-white" type="text" value="<?php echo($result["news_title"]);?>" autocomplete="off" required <?php if($status == 2) { echo('disabled'); }?>>
                                            </div>
                                            <div class="col-12">&nbsp;</div>
                                            <div class="w3-row-padding">
                                                <label class="detail">&nbsp;&nbsp;<i class="fa fa-pencil icon-detail"></i>&nbsp;&nbsp;รายละเอียดของข่าว <font class="text-danger">*</font></label>
                                                <textarea name="newsDetailInput" class="w3-input w3-border w3-white" rows="5" col="5" resize="none" autocomplete="off" required <?php if($status == 2) { echo('disabled'); }?>><?php echo($result['news_detail']);?></textarea>
                                            </div>
                                            <div class="col-12">
