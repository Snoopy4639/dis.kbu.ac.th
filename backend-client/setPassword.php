...
<html>
<head>
	<title>DIS System : ตั้งรหัสผ่านครั้งแรก</title>
	...
	<div class="container-fluid">
        ...
        <div class="col-12">
			...
			<?php while($result=mysqli_fetch_array($query,MYSQLI_ASSOC)) { ?>
				<label class="header">ตั้งรหัสผ่านเพื่อใช้งานครั้งแรก</label>
				<div class="w3-card-4 w3-light-gray">
					<form action="src/backend/set-password.php" method="POST" name="SetPassword" OnSubmit="return checkNewPassword();">
						<div class="container">
							<div class="col-12">&nbsp;</div>
							<label class="mini-header">คุณเข้าสู่ระบบ DIS เป็นครั้งแรกกรุณาตั้งรหัสผ่าน เพื่อเข้าใช้งานในครั้งถัดไป</label>
							<div class="col-12">&nbsp;</div>
							...
							<div class="col-12 text-center">
								...
								<button onclick="document.getElementById('logout').style.display='block'" type="button" class="w3-button w3-red" style="padding-top:1%">
