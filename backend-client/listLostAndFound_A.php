    ...
    <div class="container-fluid">
        <div class="col-12">
            ...
            <div class="col-10 offset-1">
                <label class="header">รายการสิ่งของที่พบ</label>
                        ...
                        <div class="col-12">
                            <table class="w3-table-all w3-hoverable text-center">
                                <thead class="text-center">
                                    <tr class="w3-amber">
                                        <th width="25%" class="text-center"><label class="detail"><font size="+0.5">ลำดับที่</font></label></th>
                                        <th width="25%" class="text-center"><label class="detail"><font size="+0.5">สิ่งของที่พบ</font></label></th>
                                        <th width="25%" class="text-center"><label class="detail"><font size="+0.5">วันที่พบ</font></label></th>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><label class="detail"><font size="+0.5"><?php echo $result['item_name']; ?></font></label></td>
                                    <td class="text-center"><label class="detail"><font size="+0.5"><?php echo $result['item_date_found'];?></font></label></td>
                                    <td class="text-center">
                                        <div class="row">
                                            <div class="col text-right">
                                                <form action="editLostAndFound_A.php" method="GET">
