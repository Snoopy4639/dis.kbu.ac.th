    ...
    <div class="container-fluid">
        <div class="col-12">
            <div class="col-10 offset-1">
                ...
                <div class="col-12">&nbsp;</div>
                <label class="header">เพิ่มข้อมูลรายการของหาย</label>
                <form action="src/backend/add-lost-item-A.php" method="POST" name="registerForm" onSubmit="JavaScript:return checkSubmit();"
                            ...
                            <div class="row">
                                    ...
                                    <div class="w3-card-2 w3-white">
                                        <div class="container-fluid">
                                            ...
                                            <div class="w3-row-padding">
                                                ...
                                                <div class="w3-half">
                                                    <label class="detail"><i class="fa fa-map-marker icon-detail"></i>&nbsp;&nbsp;สถานที่พบ <font class="text-danger">*</font></label>
                                                    <input name="locationFoundInput" class="w3-input" type="text" autocomplete="off" required>
                                                </div>
                                            </div>
                                            <div class="col-12">&nbsp;</div>
                                            <div class="w3-row-padding">
                                                <label class="detail">&nbsp;&nbsp;<i class="fa fa-pencil icon-detail"></i>&nbsp;&nbsp;รายละเอียดสิ่งของที่พบ <font class="text-danger">*</font></label>
                                            ...
                                            <div class="w3-row-padding">
                                                ...
                                                <div class="w3-half">
                                                    ...
                                                    <input name="phoneFoundInput" class="w3-input" type="text" placeholder="08XXXXXXXX" minlength="10" maxlength="10" autocomplete="off" required>
                                                </div>
                                            </div>
                                            <div class="col-12">&nbsp;</div>
                                            <div class="col-12">
                                ...
                                <div class="col-12 text-center">
                                    <button class="w3-button w3-green" type="button" onclick="document.getElementById('confirmSave').style.display='block'">
                                        <i class="fa fa-check icon-detail"></i>&nbsp;&nbsp;เพิ่มรายการของหาย
                                    </button>
