                ...
                <div class="col-12">
                    <form action="reportStudent.php" method ="GET"> 
                        <div class="w3-row-padding">
                            <div class="w3-third">
                                ...
                                <select class="w3-input w3-white" name="facultySearch">
                            ...
                            <div class="w3-third">
                                ...
                                <select class="w3-input w3-white" name="typeSearch">
                                    <option value="0" selected disabled>เลือก</option>
                            ...
                            <div class="w3-third">
                                <?php
                                    $sqlYear = "SELECT DATE_FORMAT(date_record, '%Y') AS Year FROM student_behavior_info WHERE EXISTS (Year)";
                                    $resultYear = mysqli_query($conn, $sqlYear);
                                ?>
                                <label class="mini-header">ปีการศึกษา</label>
                                <select class="w3-input w3-white" name="yearSearch">
                                    <option value="0" selected disabled>เลือก</option>
                                    <?php while($result = mysqli_fetch_array($resultYear)) {  ?>
                                        <option value="<?=$result["Year"]?>"><?php echo($result["Year"]);?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        ...
                        <div class="col-12">&nbsp;</div>
                        <button class="w3-block w3-blue w3-button" type="submit">ค้นหาข้อมูล</button>
                    </form>
                    <div class="col-12">&nbsp;</div>
                    ...
                    <?php if($_GET["view"]) { ?>
                        ...
                        <?php } else if($_GET["view"] == "2") { ?>
                            ...
                            $sqlChart = "SELECT behavior_type AS type, DATE_FORMAT(date_record, '%M') AS month, faculty_record AS faculty FROM student_behavior_info ";
                            $sqlChart .= "WHERE faculty_record LIKE $facultySearch AND behavior_type LIKE $typeSearch AND DATE_FORMAT(date_record, '%Y') LIKE '2561' GROUP BY DATE_FORMAT(date_record, '%M%')";
                            echo($sqlChart);
